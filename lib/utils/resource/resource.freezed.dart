...
/// @nodoc
class __$FailureCopyWithImpl<T, $Res> extends _$ResourceCopyWithImpl<T, $Res>
...
class _$_Failure<T> implements _Failure<T> {
  ...
  @override
  String toString() {
    return 'Resource<$T>.failure(failure: $failure)';
  }
...
abstract class _Failure<T> implements Resource<T> {
